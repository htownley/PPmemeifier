...
def main(model):
		...
		while(True):
			...
			if os.path.isfile(user_input):
				with open(user_input, 'r') as file:
					all_paragraphs = file_to_paragraph(file)
				break
			else:
	...
	while(True):
		...
		if len(relevant_text) > 0:
			print("I found {} paragraphs related to the keyword {}. Would you like to see them?".format(len(relevant_text), keyword))
			...
			print("I found {} paragraphs related to the keyword {}.".format(len(relevant_text), keyword))
